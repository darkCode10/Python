...
class Proposition:
    ...
    def printValidity(self):
        if self.isPropValid():
            print("This proposition is valid.")
        else:
            print("This proposition is not valid.")
    ...
    def printSatisfiability(self):
        if self.isPropSatisfy():
            print("This proposition is satisfied.")
        else:
            print("This proposition is not satisfied.")
